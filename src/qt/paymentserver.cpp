...
const QString BITCOIN_IPC_PREFIX("tehcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click tehcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start tehcoin: click-to-pay handler");
    else
...
{
    // clicking on tehcoin: URLs creates FileOpen events on the Mac:
